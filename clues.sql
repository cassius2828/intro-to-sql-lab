...
SELECT name,population,code FROM countries WHERE region = 'Southern Europe' ORDER BY population;
...
-- Serra | BRA | Espirito Santo | 302666
...
-- Write SQL query here
SELECT district FROM cities WHERE name = 'Serra';
-- Espirito Santo 
